...
花牌共有八張，分別為春、夏、秋、冬與梅、蘭、菊、竹。起局時莊家先檢查手牌，
若有花牌需立刻亮出並從牌牆補牌直至手中沒有花牌，再依逆時鐘讓其餘玩家補花。
遊戲進行中摸到花牌也需立即補牌。

花牌計算方式如下：

* **正花**：與自己座位對應的花牌每張一台。東家對應春、梅；南家對應夏、蘭；
  西家對應秋、菊；北家對應冬、竹。
* **花槓**：集滿四季或四君子可額外加兩台。
...
電腦玩家會依序抽牌並隨機打出一張牌，並在可以時自動吃、碰或槓。除自摸外，現在也支援吃、碰、槓與胡牌的判定，玩家可在其他人打出的牌上進行對應操作。吃、碰或槓後
請再次點擊「Draw Tile」按鈕補抓一張牌，牌面會自動排序。
在自己的回合中，必須先摸牌再打牌，如果因吃、碰或槓而補抓牌，也需要
先補抓後才能棄牌。
網頁版同樣遵循上述規則，右下角另有按鈕可切換是否顯示電腦玩家的手牌，
電腦玩家的吃、碰、槓也會在各自區域中亮出。
